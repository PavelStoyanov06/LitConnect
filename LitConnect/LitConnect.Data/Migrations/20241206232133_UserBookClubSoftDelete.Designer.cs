...
namespace LitConnect.Data.Migrations
{
    ...
    [Migration("20241206232133_UserBookClubSoftDelete")]
    partial class UserBookClubSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LitConnect.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin_user_id",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d590ac91-0581-434e-8662-9accd6d68923",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECcpL7i6eM+bRWBF794BIAauc/9N2JaQWT3RP7uv0ldIELriSCldzrxzjf0Zs8rZQw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "30a5a553-f416-4c9f-a304-76cc042adb2c",
            ...
            modelBuilder.Entity("LitConnect.Data.Models.BookClub", b =>
                {
                    ...
                    b.Property<string>("CurrentBookId")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("ID of the book currently being read");
            ...
            modelBuilder.Entity("LitConnect.Data.Models.BookGenre", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookId = "book_2",
                            GenreId = "genre_mystery",
                            IsDeleted = false
                        },
                        new
                        {
                            BookId = "book_2",
                            GenreId = "genre_thriller",
                            IsDeleted = false
                        },
                        new
                        {
            ...
            modelBuilder.Entity("LitConnect.Data.Models.UserBookClub", b =>
                {
                    b.Property<string>("BookClubId")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("ID of the book club");
                    ...
                    b.Property<bool>("IsAdmin")
                        .HasColumnType("bit")
                        .HasComment("Indicates if the user is an admin of the book club");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit")
                        .HasComment("Indicates if the membership is deleted");

                    b.Property<DateTime>("JoinedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Date when the user joined the book club");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            IsDeleted = false,
                            JoinedOn = new DateTime(2024, 12, 6, 23, 21, 30, 201, DateTimeKind.Utc).AddTicks(5694)
                        },
                        new
                        {
                            BookClubId = "club_2",
                            ...
                            IsAdmin = true,
                            IsDeleted = false,
                            JoinedOn = new DateTime(2024, 12, 6, 23, 21, 30, 201, DateTimeKind.Utc).AddTicks(5699)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "admin_role_id",
                            ConcurrencyStamp = "6e543a40-699c-4521-8a85-1669bd519256",
                            Name = "Administrator",
